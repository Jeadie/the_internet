...
from scrapers import get_all_internet_content, AFRInternetContentProvider, RedditChannelContentProvider, ProductHuntContentProvider, HackerNewsContentProvider, IndieHackerContentProvider
...
def handler(event, context):
    ...
    content_providers = [
        RedditChannelContentProvider("technology"),
        ProductHuntContentProvider(),
        HackerNewsContentProvider(),
        IndieHackerContentProvider(),
        AFRInternetContentProvider("technology")
    ]
